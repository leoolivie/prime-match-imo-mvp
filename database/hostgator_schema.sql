...
DROP TABLE IF EXISTS `prime_leads`;
DROP TABLE IF EXISTS `prime_opportunity_settings`;
...
CREATE TABLE `prime_opportunity_settings` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `prime_opportunity_settings_key_unique` (`key`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE `prime_leads` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `phone` varchar(255) DEFAULT NULL,
  `profile_type` varchar(255) NOT NULL,
  `vip_opt_in` tinyint(1) NOT NULL DEFAULT 0,
  `source` varchar(255) DEFAULT NULL,
  `opportunity_reference` varchar(255) DEFAULT NULL,
