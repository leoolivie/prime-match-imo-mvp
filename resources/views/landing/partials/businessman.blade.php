    ...
    <div class="lux-container">
        <div class="grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            <div class="space-y-6">
                ...
                <h2 class="font-poppins text-4xl font-semibold text-white">Dashboard premium com simulador de ROI e glow dourado</h2>
                <p class="text-white/60">
                    Coloque seus imóveis em evidência, acompanhe métricas em tempo real e acione concierge com atalhos dourados para acelerar cada negociação.
                </p>
                <div class="space-y-4">
                    ...
                    <ul class="space-y-3 text-sm text-white/60">
                        <li>• Alternância mensal, trimestral ou anual com comparação dinâmica de performance.</li>
                        <li>• Cartões premium com brilho dourado e acionamento direto do concierge.</li>
                        <li>• Simulador ajustável com lift de concierge, filtros de investors e métricas auxiliares.</li>
                    </ul>
                </div>
                ...
                <div class="lux-card-dark">
                    ...
                    <div class="mt-6 grid gap-4 sm:grid-cols-3">
                        <div class="lux-card-gold">
                            ...
                            <p class="mt-2 text-xs text-white/70">Match básicos e concierge guiado.</p>
                        </div>
                ...
                <div class="lux-card-dark">
                    ...
                    <div class="mt-6 grid gap-4 sm:grid-cols-2">
                        <div class="lux-stat-bubble">
                            <span class="text-white/50 text-xs uppercase tracking-[0.3em]">Receita potencial</span>
                            <span class="text-xl font-semibold text-white">R$ 4,2M</span>
                            <span class="text-white/40 text-xs">Com concierge + IA</span>
                        </div>
                        <div class="lux-stat-bubble">
                            <span class="text-white/50 text-xs uppercase tracking-[0.3em]">Lift concierge</span>
                            <span class="text-xl font-semibold text-white">+27%</span>
                            <span class="text-white/40 text-xs">Conversão em 60 dias</span>
                        </div>
                    </div>
                    <p class="mt-4 text-sm text-white/60">Ajuste preço, ocupação e pipeline de leads para simular cenários de crescimento com brilho dourado.</p>
                </div>
            </div>
        </div>
    </div>
