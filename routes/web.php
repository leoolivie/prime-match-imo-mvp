...
Route::post('/investidor/briefing', [PropertyCatalogController::class, 'customRequest'])->name('investor.custom-request');
...
Route::get('/quem-somos', [PagesController::class, 'about'])->name('about');
